...
class Team extends React.Component <{school:any;name:any;city:any;state:any}> {
  render() {
...
class TeamName extends React.Component <{school:any;}> {
  render() {
...
function TeamNames() {
  return (
    <div>
      {teamInfo.map(team => <TeamName {...team}/>)}
    </div>
  );
}
  ...
  return (
    <div className="App">
      <h1 className="App-header">
        Hello, user. Below, we have created a list of colleges. We have included the school name,
        mascot name, and the location of the school. We hope to be able to provide you this information
        so that you may be able to better enjoy March Maddness. We wish you luck with your crippling
        gambling addiction! 
      </h1>
      <body>
        <h3>List of Teams:</h3>
